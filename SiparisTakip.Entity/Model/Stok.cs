namespace SiparisTakip.Entity.Model
{
    ...
    public partial class Stok
    {
        ...
        public Stok()
        {
            ...
            StokDepoes = new HashSet<StokDepo>();
            StokETicarets = new HashSet<StokETicaret>();
            StokHarekets = new HashSet<StokHareket>();
            StokResims = new HashSet<StokResim>();
            StokSayimDetays = new HashSet<StokSayimDetay>();
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<StokDepo> StokDepoes { get; set; }

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<StokETicaret> StokETicarets { get; set; }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<StokSayimDetay> StokSayimDetays { get; set; }
